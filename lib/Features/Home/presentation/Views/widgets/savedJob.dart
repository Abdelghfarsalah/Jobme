...
class savedjob extends StatefulWidget {
  ...
  @override
  State<savedjob> createState() => _JobinformationState();
}

class _JobinformationState extends State<savedjob> {
  @override
                        ...
                        const  SizedBox(
                          ...
                          IconButton(
                              onPressed: () {setState(() {
                                ...
                                BlocProvider.of<SavedJobCubit>(context).removetolist(model:widget. model);
                              });
                              },
